...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($_POST['action'])) {
    ...
    // Lấy loại công việc từ form và đặt giá trị mặc định là 'khong' nếu không có
    $muc1_task_type = $_POST['muc1_task_type'] ?? 'khong';
    $muc2_task_type = $_POST['muc2_task_type'] ?? 'khong';
    $muc3_task_type = $_POST['muc3_task_type'] ?? 'khong';
    $muc4_task_type = $_POST['muc4_task_type'] ?? 'khong';
    $muc5_task_type = $_POST['muc5_task_type'] ?? 'khong';
    $muc6_task_type = $_POST['muc6_task_type'] ?? 'khong';
    ...
    $tongGioChuan = $muc1_gio + $muc2_gio + $muc3_gio + $muc4_gio + $muc5_gio + $muc6_gio + 
                    $muc7_gio + $muc8_gio + $muc9_gio + $muc10_gio + $muc11_gio;
    ...
    try {
        if ($exists) {
            ...
            $stmt = $conn->prepare("
                UPDATE coi_thi SET 
                    muc1_so_cau = :muc1_so_cau,
                    muc2_so_cau = :muc2_so_cau,
                    muc3_so_cau = :muc3_so_cau,
                    muc4_so_cau = :muc4_so_cau,
                    muc5_so_cau = :muc5_so_cau,
                    muc6_so_cau = :muc6_so_cau,
                    muc7_so_cau = :muc7_so_cau,
                    muc8_so_cau = :muc8_so_cau,
                    muc9_so_cau = :muc9_so_cau,
                    muc10_so_cau = :muc10_so_cau,
                    muc11_so_cau = :muc11_so_cau,
                    muc1_gio_quy_doi = :muc1_gio,
                    muc2_gio_quy_doi = :muc2_gio,
                    muc3_gio_quy_doi = :muc3_gio,
                    muc4_gio_quy_doi = :muc4_gio,
                    muc5_gio_quy_doi = :muc5_gio,
                    muc6_gio_quy_doi = :muc6_gio,
                    muc7_gio_quy_doi = :muc7_gio,
                    muc8_gio_quy_doi = :muc8_gio,
                    muc9_gio_quy_doi = :muc9_gio,
                    muc10_gio_quy_doi = :muc10_gio,
                    muc11_gio_quy_doi = :muc11_gio,
                    muc1_task_type = :muc1_task_type,
                    muc2_task_type = :muc2_task_type,
                    muc3_task_type = :muc3_task_type,
                    muc4_task_type = :muc4_task_type,
                    muc5_task_type = :muc5_task_type,
                    muc6_task_type = :muc6_task_type,
            ...
            $stmt = $conn->prepare("
                INSERT INTO coi_thi (
                    ...
                    muc1_so_cau, muc2_so_cau, muc3_so_cau, muc4_so_cau, muc5_so_cau,
                    muc6_so_cau, muc7_so_cau, muc8_so_cau, muc9_so_cau, muc10_so_cau,
                    muc11_so_cau,
                    muc1_gio_quy_doi, muc2_gio_quy_doi, muc3_gio_quy_doi, muc4_gio_quy_doi,
                    muc5_gio_quy_doi, muc6_gio_quy_doi, muc7_gio_quy_doi, muc8_gio_quy_doi,
                    muc9_gio_quy_doi, muc10_gio_quy_doi, muc11_gio_quy_doi,
                    muc1_task_type, muc2_task_type, muc3_task_type, muc4_task_type,
                    muc5_task_type, muc6_task_type,
                    tong_gio_quy_doi
                ) VALUES (
                    :employeeID, :result_year,
                    :muc1_so_cau, :muc2_so_cau, :muc3_so_cau, :muc4_so_cau, :muc5_so_cau,
                    :muc6_so_cau, :muc7_so_cau, :muc8_so_cau, :muc9_so_cau, :muc10_so_cau,
                    :muc11_so_cau,
                    :muc1_gio, :muc2_gio, :muc3_gio, :muc4_gio, :muc5_gio,
                    :muc6_gio, :muc7_gio, :muc8_gio, :muc9_gio, :muc10_gio,
                    :muc11_gio,
                    :muc1_task_type, :muc2_task_type, :muc3_task_type, :muc4_task_type,
                    :muc5_task_type, :muc6_task_type,
                    :tong_gio_quy_doi
        ...
        $stmt->execute($params);
        echo "<script>showPopup('Dữ liệu đã được " . ($exists ? "cập nhật" : "lưu") . " thành công cho năm $selectedYear', 'success');</script>";
    } catch (PDOException $e) {
        echo "<script>showPopup('Lỗi: " . $e->getMessage() . "', 'error');</script>";
    }
}
?>
...
<body>
    ...
    <div style="text-align: center; margin-bottom: 15px;">
        <form method="POST" action="" id="yearForm">
            ...
            <select name="selected_year" id="selectedYear" class="year-select" onchange="this.form.submit()">
                <?php
                $currentYear = date('Y');
                $selectedYear = isset($_POST['selected_year']) ? $_POST['selected_year'] : ($currentYear - 1);
    ...
    <script>
        ...
        function handleSubmit(event) {
            ...
            showConfirmPopup('Bạn có chắc chắn muốn cập nhật dữ liệu không?', () => {
