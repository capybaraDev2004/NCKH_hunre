...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 05, 2025 lúc 05:30 AM
...
-- Thủ tục
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateTongHopNCKH` (IN `p_employeeID` INT, IN `p_result_year` INT)   BEGIN
    -- Tính tổng giờ từ các bảng history
    DECLARE total_hours FLOAT DEFAULT 0;
    
    -- Tính từ bảng nckhcc_history
    SELECT COALESCE(SUM(gio_quy_doi), 0) INTO total_hours
    FROM nckhcc_history
    WHERE employeeID = p_employeeID AND result_year = p_result_year;
    
    -- Cộng thêm từ bảng vietsach_history
    SELECT total_hours + COALESCE(SUM(gio_quy_doi), 0) INTO total_hours
    FROM vietsach_history
    WHERE employeeID = p_employeeID AND result_year = p_result_year;
    
    -- Cộng thêm từ bảng huongdansv_history
    SELECT total_hours + COALESCE(SUM(gio_quy_doi), 0) INTO total_hours
    FROM huongdansv_history
    WHERE employeeID = p_employeeID AND result_year = p_result_year;
    
    -- Cộng thêm từ bảng bai_bao_history
    SELECT total_hours + COALESCE(SUM(gio_quy_doi), 0) INTO total_hours
    FROM bai_bao_history
    WHERE employeeID = p_employeeID AND result_year = p_result_year;
    
    -- Cập nhật hoặc thêm mới vào bảng tong_hop_nckh
    INSERT INTO tong_hop_nckh (employeeID, result_year, tong_gio_nckh)
    VALUES (p_employeeID, p_result_year, total_hours)
    ON DUPLICATE KEY UPDATE
        tong_gio_nckh = total_hours,
...
--
-- Cấu trúc bảng cho bảng `bai_bao_history`
--
...
--
-- Đang đổ dữ liệu cho bảng `bai_bao_history`
--

INSERT INTO `bai_bao_history` (`id`, `employeeID`, `result_year`, `nckh_id`, `noi_dung`, `ten_san_pham`, `so_luong`, `so_tac_gia`, `phan_tram_dong_gop`, `gsnn_id`, `gio_quy_doi`, `ngay_cap_nhat`, `vai_tro`, `note`) VALUES
(114, 2, 2024, 1, 'Bài báo đăng trên tạp chí khoa học quốc tế trong danh mục ISI, SCI, SCIE, Scopus (Q1) hoặc kỷ yếu hội nghị quốc tế CORE A', 'q1', 1, 3, 10, NULL, 317.5, '2025-04-25 03:45:58', 'Chủ nhiệm', '0');
...
--
-- Cấu trúc bảng cho bảng `create_schedules`
--
...
--
-- Cấu trúc bảng cho bảng `dien_tap`
--
...
--
-- Đang đổ dữ liệu cho bảng `dien_tap`
--
...
--
-- Cấu trúc bảng cho bảng `hoi_dong`
--
...
--
-- Đang đổ dữ liệu cho bảng `hoi_dong`
--
...
--
-- Cấu trúc bảng cho bảng `huongdansvnckh`
--
...
--
-- Đang đổ dữ liệu cho bảng `huongdansvnckh`
--
...
--
-- Cấu trúc bảng cho bảng `huongdansv_history`
--
...
--
-- Cấu trúc bảng cho bảng `nckhcc_history`
--
...
CREATE TABLE `nckhcc_history` (
  ...
  `thanh_vien` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Cấu trúc bảng cho bảng `nghiencuukhoahoccaccap`
--
...
--
-- Đang đổ dữ liệu cho bảng `nghiencuukhoahoccaccap`
--
...
--
-- Cấu trúc bảng cho bảng `nv3_hours`
--
...
--
-- Cấu trúc bảng cho bảng `ra_de_thi`
--
...
--
-- Đang đổ dữ liệu cho bảng `ra_de_thi`
--
...
--
-- Cấu trúc bảng cho bảng `task_registrations`
--
...
--
-- Đang đổ dữ liệu cho bảng `task_registrations`
--
...
--
-- Cấu trúc bảng cho bảng `tong_hop_nckh`
--
...
--
-- Đang đổ dữ liệu cho bảng `tong_hop_nckh`
--
...
(2, 2024, 317.5, 0, 'Chưa hoàn thành', '2025-04-28 12:43:21'),
(2, 2025, 0, 0, 'Chưa hoàn thành', '2025-04-28 13:20:43');
...
--
-- Đang đổ dữ liệu cho bảng `total_hours`
--
...
--
-- Cấu trúc bảng cho bảng `vietbaibao`
--
...
--
-- Đang đổ dữ liệu cho bảng `vietbaibao`
--
...
--
-- Cấu trúc bảng cho bảng `vietsach`
--
...
--
-- Đang đổ dữ liệu cho bảng `vietsach`
--
...
--
-- Cấu trúc bảng cho bảng `vietsach_history`
--
...
--
-- Chỉ mục cho bảng `bai_bao_history`
--
...
--
-- Chỉ mục cho bảng `create_schedules`
--
...
--
-- Chỉ mục cho bảng `huongdansvnckh`
--
ALTER TABLE `huongdansvnckh`
  ADD PRIMARY KEY (`ID`);

--
-- Chỉ mục cho bảng `huongdansv_history`
--
...
--
-- Chỉ mục cho bảng `nckhcc_history`
--
...
--
-- Chỉ mục cho bảng `nghiencuukhoahoccaccap`
--
ALTER TABLE `nghiencuukhoahoccaccap`
  ADD PRIMARY KEY (`ID`);

--
-- Chỉ mục cho bảng `nv3_hours`
--
...
--
-- Chỉ mục cho bảng `task_registrations`
--
...
--
-- Chỉ mục cho bảng `tong_hop_nckh`
--
...
--
-- Chỉ mục cho bảng `vietbaibao`
--
ALTER TABLE `vietbaibao`
  ADD PRIMARY KEY (`ID`);

--
-- Chỉ mục cho bảng `vietsach`
--
ALTER TABLE `vietsach`
  ADD PRIMARY KEY (`ID`);

--
-- Chỉ mục cho bảng `vietsach_history`
--
...
--
-- AUTO_INCREMENT cho bảng `bai_bao_history`
--
ALTER TABLE `bai_bao_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT cho bảng `create_schedules`
--
ALTER TABLE `create_schedules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `dien_tap`
--
ALTER TABLE `dien_tap`
...
--
-- AUTO_INCREMENT cho bảng `hoi_dong`
--
ALTER TABLE `hoi_dong`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT cho bảng `huongdansv_history`
--
ALTER TABLE `huongdansv_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT cho bảng `nckhcc_history`
--
ALTER TABLE `nckhcc_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT cho bảng `nv3_hours`
--
ALTER TABLE `nv3_hours`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `task_registrations`
--
ALTER TABLE `task_registrations`
...
--
-- AUTO_INCREMENT cho bảng `vietbaibao`
--
ALTER TABLE `vietbaibao`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT cho bảng `vietsach_history`
--
ALTER TABLE `vietsach_history`
...
--
-- Các ràng buộc cho bảng `huongdansv_history`
--
ALTER TABLE `huongdansv_history`
...
--
-- Các ràng buộc cho bảng `nckhcc_history`
--
ALTER TABLE `nckhcc_history`
...
--
-- Các ràng buộc cho bảng `vietsach_history`
--
ALTER TABLE `vietsach_history`
